...
export default function Predict() {
  ...
  return (
    <div>
      <section className="bg-coolGray-800 text-amber-500 h-screen">
        <div className="container flex flex-col items-center mx-auto space-y-6 md:p-8">
          <p className=" py-2 text-2xl font-semibold text-center sm:font-bold sm:text-3xl md:text-4xl lg:max-w-2xl xl:max-w-4xl text-amber-500">
          ...
          <div className="h-96">
            {imgData === null ? (
              <img
                className="rounded-lg border-4 border-amber-500"
